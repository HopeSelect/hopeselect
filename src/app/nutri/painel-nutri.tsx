  ...
  return (
    <div className="flex flex-wrap gap-4 p-4">
      {nutricionistas.map((nutricionista) => {
        ...
        return (
          <div key={nutricionista.id} className="w-64 shrink-0 rounded-lg border border-gray-200 bg-white shadow-sm">
            <div className="flex items-center gap-2 rounded-t-lg border-b border-gray-100 bg-gray-50 px-3 py-2">
              ...
              <div className="min-w-0 flex-1">
                <p className="truncate text-sm font-semibold text-gray-900">{nutricionista.nome}</p>
                {nutricionista.horario_trabalho && (
                  <p className="truncate text-xs text-gray-500">{nutricionista.horario_trabalho}</p>
                )}
              </div>
              <span
